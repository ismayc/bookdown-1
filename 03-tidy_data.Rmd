...
**Force dataframes into tibbles using `as_tibble` or `tbl_df`?  That way `head` isn't needed since printing will be nice by default. <http://r4ds.had.co.nz/tibbles.html>**
...
If we `View` this dataset, we see a new variable has been created called (We will see in Chapter \@ref(manip) ways to change `name` to a more descriptive variable name.)
