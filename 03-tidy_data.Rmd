...
```{r tidyfig, echo=FALSE, fig.align='center', fig.cap="Tidy data graphic from http://r4ds.had.co.nz/tidy-data.html"}
...
If we `View` this dataset, we see a new variable has been created called (We will see in Subsection \@ref(select) ways to change `name` to a more descriptive variable name.)
