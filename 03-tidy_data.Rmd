...
**Force dataframes into tibbles using `as_tibble`?  That way `head` isn't needed since printing will be nice by default. <http://r4ds.had.co.nz/tibbles.html>**

**Add RStudio graphics**
