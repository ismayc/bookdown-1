...
needed_pkgs <- c("nycflights13", "dplyr", "ggplot2", "knitr", 
  "ggplot2movies", "dygraphs", "rmarkdown")
...
knitr::write_bib(c(
  ...
  'dygraphs', 'tufte', 'ggplot2movies'
), 'bib/packages.bib')
```

## Colophon

The source of the book is available [here](https://github.com/ModernStats/bookdown) and was built with versions of R packages given here.  This may not be of importance for initial readers of this book, but you can reproduce a duplicate of this book by installing these versions of the packages.
