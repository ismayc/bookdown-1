...
\NormalTok{\}}
\CommentTok{# Check that phantomjs is installed on the Mac.  Will need to run on the PC}
\NormalTok{if(}\KeywordTok{Sys.which}\NormalTok{(}\StringTok{"phantomjs"}\NormalTok{) !=}\StringTok{ ""}\NormalTok{)}
