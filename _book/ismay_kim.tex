...
\NormalTok{needed_pkgs <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"nycflights13"}\NormalTok{, }\StringTok{"dplyr"}\NormalTok{, }\StringTok{"ggplot2"}\NormalTok{, }\StringTok{"knitr"}\NormalTok{, }
  \StringTok{"devtools"}\NormalTok{, }\StringTok{"ggplot2"}\NormalTok{)}
...
\begin{verbatim}
## [1] "Saturday, July 30, 2016 20:04:09 EDT"
\end{verbatim}
...
\tightlist
\item
  Median flight arrival delay by day
\end{itemize}
...
\begin{verbatim}
## [1] "Saturday, July 30, 2016 20:04:25 EDT"
\end{verbatim}
...
\begin{figure}
\includegraphics{ismay_kim_files/figure-latex/unnamed-chunk-34-1} \caption[Number of flights departing NYC in 2013 by airline - Descending numbers]{Number of flights departing NYC in 2013 by airline - Descending numbers}\label{fig:unnamed-chunk-34}
\end{figure}
